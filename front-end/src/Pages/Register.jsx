          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form>
              ...
              <div className="my-3">
                ...
                <input type="text" name="registro" id="registro" className="bg-gray-100 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 hover:bg-gray-50" placeholder="Código"  
                />
              </div>
